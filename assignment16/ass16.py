...
# db=py.connect("localhost","root","123","library")
# cursor=db.cursor()
# cursor.execute("insert into book values(001,'looking for bhupispy','india','fiction')")
# cursor.execute("insert into titles values(001,'looking for bhupispy','1005',115,2018)")
# cursor.execute("insert into publisher values(001,'ABC','usa',10002,11001)")
# cursor.execute("insert into zip_code values(001,'dehradun','uttrakhand',136129)")
